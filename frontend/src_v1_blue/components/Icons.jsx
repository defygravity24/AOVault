// Icon components for AOVault
// Using inline SVG for simplicity - can migrate to icon library later

export const VaultIcon = ({ className = "w-8 h-8" }) => (
...
export const HeartIcon = ({ filled, className = "w-5 h-5" }) => (
